...
cards = [ # art, name, type, energy, description
    ...
    # ("./art/cards/beer/inchs.png","Inchs", "attack", 1,["Deal 1 $Damage$","to ALL enemies","take 1 $sip$"]),
    ("./art/cards/beer/peroni.png","Peroni", "skill", 2,["All players gain","2 $Block$","take a $sip$"]),
    ...
    ("./art/cards/cocktail/schnapp_to_it.png","Schnapp to it", "skill", 2,["$Brew$ a splash","of $peach schnapps$"]),
    ...
    ("./art/cards/driver/sealant.png","Sealant", "skill", 3,["All players","$heal$ fully", "$Exhaust$"]),
    ...
    # ("./art/cards/misc/beer.png","Beermaster","player",-1,["Big $Hitter$","$Sips$ a lot","$Debuffs$ foes"],[20,60,2.5]),
    # ("./art/cards/misc/wine.png","Wine Connoiseur","player",-1,["Barrage of $grapes$","$Status$ wizard","$Draws$ a lot"],[20,60,2.5]),
    # ("./art/cards/misc/cocktail.png","Cocktail mixer","player",-1,["$Brew$ your own","Gets em $tipsy$","Natural $gambler$"],[20,60,2.5]),
    # ("./art/cards/misc/driver.png","Designated Driver","player",-1,["Drink $avoider$","$Team$ player","Drug $dealer$"],[20,60,2.5]),
    ("./art/cards/winecon/grape.png","Grape", "attack", 0,["Deal 1 $Damage$","take 1 $sip$","$exhaust$"]),
    ("./art/cards/winecon/grape.png","Grape", "attack", 0,["Deal 1 $Damage$","take 1 $sip$","$exhaust$"]),
    ("./art/cards/winecon/grape.png","Grape", "attack", 0,["Deal 1 $Damage$","take 1 $sip$","$exhaust$"]),
    ("./art/cards/winecon/grape.png","Grape", "attack", 0,["Deal 1 $Damage$","take 1 $sip$","$exhaust$"]),
    ("./art/cards/winecon/grape.png","Grape", "attack", 0,["Deal 1 $Damage$","take 1 $sip$","$exhaust$"]),
    ...
    ("./art/cards/misc/adminTemplate.png","Quick Mode","admin",-1,["Only do $5 floors$","double $score$"],[20,60,2.5]),
]
